...
<html lang="en">
  <head>
    <title>Power Of The Word Internation</title>
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.php"><i class="flaticon-cross"></i> <span>POWER OF THE WORD</span> <span>International</span></a>
    ...
    <section id="home" class="video-hero js-fullheight" style="height: 700px; background-image: url(images/bg_1.jpg);  background-size:cover; background-position: center center;background-attachment:fixed;" data-section="home">
			...
			<a class="player" data-property="{videoURL:'https://www.youtube.com/watch?v=AKolQceAZQk',containment:'#home', showControls:false, autoPlay:true, loop:true, mute:false, startAt:0, opacity:1, quality:'default'}"></a>
			<div class="container">
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="logo"><i class="flaticon-cross"><a href="index.html"></i><span>Wisdom</span><span>Church</span></a></h2>
